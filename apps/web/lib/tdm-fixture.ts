export const TDM_FIXTURE = {
  ...
  sdks: [
    ...
    },
    {
      ...
      api_methods: ["s3.put_object", "s3.get_object", "ses.send_email"],
      locations: [
  ...
  infrastructure: [
    {
      id: "infra:postgresql/DATABASE_URL",
      type: "postgresql",
      ...
      locations: [
        {
          ...
          line: 5,
          context: "psycopg2.connect(os.environ['DATABASE_URL'])",
          usage: "env_var",
        },
      ],
      confidence: "high",
      ...
      locations: [
        {
          ...
          line: 3,
          context: "redis.from_url(os.environ['REDIS_URL'])",
          usage: "env_var",
        },
      ],
      confidence: "high",
  ...
  webhooks: [
    {
      id: "webhook:outbound/stripe-endpoint",
      direction: "outbound_registration",
      target_url: "https://api.stripe.com/v1/webhook_endpoints",
      provider: "stripe",
      locations: [
        {
          file: "webhooks/register.py",
          line: 12,
          context: "stripe.WebhookEndpoint.create(url=WEBHOOK_URL, ...)",
          usage: "method_call",
        },
      ],
      confidence: "medium",
    ...
    {
      id: "webhook:inbound/stripe-callback",
      ...
      locations: [
        {
          ...
          line: 24,
          context: "@app.route('/webhooks/stripe', methods=['POST'])",
          usage: "route_handler",
        },
      ],
      confidence: "high",
...
export type TDMFixture = typeof TDM_FIXTURE;

export const TDM_SECTIONS = [
  { key: "packages", label: "Packages", icon: "📦", count: TDM_FIXTURE.packages.length },
  { key: "apis", label: "APIs", icon: "🌐", count: TDM_FIXTURE.apis.length },
  { key: "sdks", label: "SDKs", icon: "🔧", count: TDM_FIXTURE.sdks.length },
  {
    key: "infrastructure",
    label: "Infrastructure",
    icon: "🗄️",
    count: TDM_FIXTURE.infrastructure.length,
  },
  { key: "webhooks", label: "Webhooks", icon: "🔗", count: TDM_FIXTURE.webhooks.length },
] as const;
